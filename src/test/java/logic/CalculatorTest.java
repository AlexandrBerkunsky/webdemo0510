...
class CalculatorTest {
    ...
    void testFillArrayY() {
        ...
        double expected1 = 1.;
        double expected2 = -0.329_742;
        double expected3 = 0.214_243;
        double[] y = calculator.fillArrayY(x);
        assertEquals(expected1, y[175], EPS, "y1 error");
        assertEquals(expected2, y[350], EPS, "y2 error");
    ...
    void testAvgArray() {
        ...
        assertEquals(expected, result, EPS, "avgArray error");
    }
}